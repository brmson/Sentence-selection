...
import numpy as np
from const import *
CPATH="data/jacana/Clues.txt"
def saveQlist(QPATH,APATH1,APATH0,GLOVEPATH,GLOVEPATH2,PLIST,PANS1,PANS0,new_dict=False,clues=False):
    ...
    sentences=(q,a1,a0)
    li=ttlist(qa,a1a,a0a,ans1,ans0,sentences,clues)
    pickle.dump( li, open( PLIST , "wb" ) )
    np.savetxt(PANS1,ans1)
    np.savetxt(PANS0,ans0)
    return
    
saveQlist(QPATH,APATH1,APATH0,GLOVEPATH,GLOVEPATH2,LISTPATH,PANS1,PANS0,new_dict=True)#clues=True
print 'training data saved'
saveQlist(TQPATH,TAPATH1,TAPATH0,GLOVEPATH,TGLOVEPATH2,TLISTPATH,PTANS1,PTANS0,new_dict=True)
